...
const Sidebar = () => {
  ...
  return (
    <div className=' flex flex-col gap-4 p-3 h-screen'>
        <Link href="/">
          <FaXTwitter className=' w-16 h-16 p-3 hover:bg-gray-100
      ...
      {session ?  <button className='bg-blue-400 text-white rounded-full
